...
export default function EditPerson() {
    ...
    const onSubmit =async (e) => {
        e.preventDefault();
        await axios.put(`http://localhost:8080/api/person/${id}`,person);
        navigate("/")
    ...
    const loadPerson = async ()=>{
        const result = await axios.get(`http://localhost:8080/api/person/${id}`)
        ...
        <div className='container'>
            <div className='row'>
                <div className='col-md-6 offset-md-3 border rounded p-4 mt-2 shadow'>
                    <h2 className='text-center m-4'>Izmeni Korisnika</h2>
